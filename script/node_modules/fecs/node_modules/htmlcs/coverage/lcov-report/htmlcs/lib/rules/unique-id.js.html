...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/rules/unique-id.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/rules/</a> &#187; unique-id.js</div>
</div>
<div class="body">
...
&nbsp;
        document.querySelectorAll('[id]').forEach(function (element) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (element.id) {
...
&nbsp;
        for (var id in idMap) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (idMap.hasOwnProperty(id)) {
