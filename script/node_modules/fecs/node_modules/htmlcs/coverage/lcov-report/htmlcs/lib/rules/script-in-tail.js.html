...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/rules/script-in-tail.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/rules/</a> &#187; script-in-tail.js</div>
</div>
<div class="body">
...
&nbsp;
        if (!enable || !(html  || <span class="branch-1 cbranch-no" title="branch not covered" >body)</span>) {
            return;
        }
&nbsp;
