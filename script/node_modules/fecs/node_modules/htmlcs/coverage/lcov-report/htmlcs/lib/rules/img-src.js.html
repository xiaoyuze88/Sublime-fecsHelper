...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/rules/img-src.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/rules/</a> &#187; img-src.js</div>
</div>
<div class="body">
...
&nbsp;
        document.querySelectorAll('img[src=""]').forEach(function (img) {
            reporter.warn(img, '013', 'Attribute "src" of &lt;img&gt; should not be empty.');
        });
&nbsp;
    }
&nbsp;
