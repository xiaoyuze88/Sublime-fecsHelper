...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/</a> &#187; config.js</div>
</div>
<div class="body">
...
var getConfigFileUnderHomePath = function () {
    ...
    return homePath ? getConfigFileUnder(homePath) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
};
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (configFile = getConfigFileUnderHomePath()) {
