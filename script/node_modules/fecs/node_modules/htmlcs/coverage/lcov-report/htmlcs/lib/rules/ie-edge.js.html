...
<div class="header high">
    <h1>Code coverage report for <span class="entity">htmlcs/lib/rules/ie-edge.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">htmlcs/lib/rules/</a> &#187; ie-edge.js</div>
</div>
<div class="body">
...
&nbsp;
        ...
        head.querySelectorAll('meta').forEach(function (meta) {
            if (
                ...
                (meta.getAttribute('content') || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.toLowerCase() === 'ie=edge'
            ) {
                hasEdgeMeta = true;
            }
        });
